  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <section id="about" className="relative overflow-hidden scroll-mt-16">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
          <motion.div
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border-2 border-primary text-primary text-sm font-medium mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight mb-3">
              Manage Projects
              <span className="block text-3xl sm:text-4xl lg:text-6xl mt-2 bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-400 bg-clip-text text-transparent font-unbounded py-2">
                With Clarity & Focus
              </span>
            </h1>
      ...
      <section className="bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            {stats.map((stat, i) => (
              <div key={i} className="text-center font-sofia">
      ...
      <section
        id="features"
        className="scroll-mt-16 py-24 relative overflow-hidden bg-[url('/images/bg2.png')] 
          bg-cover
          bg-center
          bg-no-repeat"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold font-unbounded text-slate-900 mb-4">
              Everything you need to manage projects
            </h2>
            <p className="text-lg text-border font-sofia">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {features.map((feature, i) => (
              ...
              >
                ...
                <h3 className="font-semibold font-inter text-lg text-slate-900 mb-2">
                  {feature.title}
                </h3>
                <p className="text-slate-600 font-sofia">
                  {feature.description}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold font-unbounded text-white mb-4">
              Ready to transform your workflow?
            </h2>
            <p className="text-lg font-sofia text-slate-300 mb-8">
      ...
      <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-slate-50">
